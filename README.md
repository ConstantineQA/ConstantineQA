...
Для демонстрации навыков работы с тестовой документацией я написал предполагаемое техническое задание на новый функционал для якобы разарабатываемого несуществующего веб-приложения. Техническое задание можно посмотреть здесь: [Specification](https://github.com/ConstantineQA/Specification). Ниже я привожу примеры оформляемой мной тестовой документации на примере функционала приложения, описанного в техническом задании: 
